...
/**
 * A utility to call a restful service and reduce repetitive code
 * for dispatching failure/pending/success actions.
 *
 ...
 */
export function callApi(url, actionType, method, payload) {
